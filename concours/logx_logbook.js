...
// ─── QUESTIONS SUR LE CARNET (C1) : extrait vers logx_carnet_questions.js
// (EV-7, 14/09/2026, docs/LogX_AI_PRD.md) -- charge en <script> classique
// dans logx_logbook.html, portee globale partagee. Contient carnetHistorique/
// CARNET_HISTORIQUE_MAX/showCarnetQuestions/closeCarnetQuestions/
// poserQuestionCarnet/poserQuestionLibreCarnet/reinitialiserConversationCarnet/
// majIndicateurConversationCarnet. Candidat vérifié sans ambiguïté avant
// déplacement : aucune fonction/variable de ce bloc n'est atteignable depuis
// submitQSO()/renderLog()/autoFillQso() (chemin critique) -- contrairement au
// moteur de filtres juste au-dessus et à validateLocator() plus bas, qui eux
// restent délibérément ici (voir leurs commentaires respectifs).
