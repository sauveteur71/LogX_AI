...
CABRILLO_FREQ = {
    ...
    '21': '21000', '28': '28000', '50': '50', '70': '70',
    '144': '144', '432': '432', '1296': '1.2G', '2320': '2.3G',
...
ADIF_BAND = {
    '1.8': '160m', '3.5': '80m', '7': '40m', '14': '20m', '21': '15m',
    '28': '10m', '50': '6m', '70': '4m', '144': '2m', '432': '70cm',
    '1296': '23cm', '2320': '13cm', '3400': '9cm', '5760': '6cm',
...
def build_adif(qsos, cfg=None):
    ...
    cfg = cfg or {}
    callsign = (cfg.get('callsign_contest') or cfg.get('callsign', '')).upper()
    header = (f"Log RadioContest AI — {callsign}\n"
              + _adif_field('adif_ver', '3.1.4')
              + _adif_field('programid', 'RadioContest AI')
              + '<EOH>\n')
    records = []
    for q in qsos:
        date, time = _qso_datetime(q)
