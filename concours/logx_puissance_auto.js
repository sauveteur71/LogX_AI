...
// DÉCLARATIONS AU PREMIER NIVEAU, et pas dans une IIFE qui poserait tout sur
// window : dans un navigateur `window` EST l'objet global, donc les deux
// reviennent au même — mais nulle part ailleurs. Un banc de test où `window`
// est un objet ordinaire ne voyait pas les fonctions, et l'appel du LOGBOOK,
// gardé par un `typeof`, redevenait silencieusement inopérant. C'est très
// exactement le défaut que ce module corrige : il n'avait pas à se reproduire
// dans le correctif lui-même. Les affectations sur window sont conservées plus
// bas pour qui préfère les nommer explicitement.
'use strict';
