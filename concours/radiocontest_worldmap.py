...
géographique de la chasse aux pays (radiocontest_countries.py), qui reste la
...
(comme le fait déjà radiocontest_departments.py pour le locator → département).
...
def worked_by_country(shared_log, contest_id=''):
    ...
    (radiocontest_countries, même logique que la chasse aux pays en liste)."""
    from radiocontest_countries import _worked_keys
