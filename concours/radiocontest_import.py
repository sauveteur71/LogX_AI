...
Corrige un import ADIF PRÉ-EXISTANT côté client (radiocontest_logbook.js
...
(radiocontest_qsl._parse_adif_records — gère correctement le format
...
from radiocontest_qsl import _parse_adif_records, _band_from_record
