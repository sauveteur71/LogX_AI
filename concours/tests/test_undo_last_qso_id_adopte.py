...
CLOCK_JS = os.path.join(BASE, 'logx_clock.js')  # EV-7 47e increment : updateClockAndCountdown top-level (cablage)
...
def _load_ctx():
    ...
    for p in (RULES_JS, ESM_CALLBOT_JS, VOICE_KEYER_JS, EXPORT_EDI_JS, SOAPBOX_JS,
              FILTRE_SPOTS_JS, AUDIO_RECORDER_JS, CLOCK_JS, LOGBOOK_JS, EDIT_QSO_JS):
