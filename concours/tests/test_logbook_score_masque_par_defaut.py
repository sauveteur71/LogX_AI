...
def _make_ctx():
    ...
    for path in (RULES_JS_PATH, QTC_JS_PATH, ESM_CALLBOT_JS_PATH, VOICE_KEYER_JS_PATH, FILTRE_SPOTS_JS_PATH, AUDIO_RECORDER_JS_PATH, SCORING_CLIENT_JS_PATH, JS_PATH):
