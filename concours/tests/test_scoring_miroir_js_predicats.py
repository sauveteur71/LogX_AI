...
# EV-7 39e incrément : le scoring client (evalPointsFromDef/calcPoints/...) a été
# extrait de logx_logbook.js vers logx_scoring_client.js (chargé avant, global).
...
def _real_source():
    ...
    for path in (RULES_JS_PATH, HARDWARE_JS_PATH, DXCC_JS_PATH, CALLBOOK_JS_PATH, LOOKUP_JS_PATH, ESM_CALLBOT_JS_PATH,
                 ...
                 FILTRE_SPOTS_JS_PATH, OUTILS_DIVERS_JS_PATH, AUDIO_RECORDER_JS_PATH, CLOCK_JS_PATH, SCORING_CLIENT_JS_PATH, JS_PATH):
