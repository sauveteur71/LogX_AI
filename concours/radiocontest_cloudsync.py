...
fichiers que l'opérateur utilise déjà. radiocontest_backup.py y écrit déjà
...
fichier (radiocontest_cloudsync_<indicatif>_<id installation>.json), jamais
...
SYNC_PREFIX = 'radiocontest_cloudsync_'
